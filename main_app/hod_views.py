...
def add_session(request):
    ...
    context = {'form': form, 'page_title': 'Session', 'page_title_2': 'Session Panel'}
    if request.method == 'POST':
        if form.is_valid():
            try:
                form.save()
...
def manage_session(request):
    ...
    context = {'sessions': sessions, 'page_title': 'Session', 'page_title_2': 'Session Panel'}
