...
urlpatterns = [
    ...
    path('staff/view/courses/', staff_views.staff_view_courses,
         name='staff_view_courses'),
    ...
    path('staff/view/inbox/', staff_views.staff_view_inbox,
         name='staff_view_inbox'),
    path('staff/view/inbox/send/', staff_views.staff_view_inbox_send,
         name='staff_view_inbox_send'),
    path('staff/view/lesson/', staff_views.staff_view_lesson,
         name='staff_view_lesson'),
    path('staff/view/students/', staff_views.staff_view_students,
         name='staff_view_students'),
    path('staff/view/grades/', staff_views.staff_view_grades,
         name='staff_view_grades'),
    ...
    path('student/view/subjects/list', student_views.student_view_subjects_list,
         name='student_view_subjects_list'),
    path('student/view/inbox/', student_views.student_view_inbox,
         name='student_view_inbox'),
    path('student/view/inbox/send/', student_views.student_view_inbox_send,
         name='student_view_inbox_send'),
    path('student/view/lesson/', student_views.student_view_lesson,
         name='student_view_lesson'),
    path('student/view/subject/', student_views.student_view_subject,
         name='student_view_subject'),
    path('student/view/grades/', student_views.student_view_grade,
